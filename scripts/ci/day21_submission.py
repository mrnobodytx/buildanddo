...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--target-audience", default="Small business owners and operators"
    )
    parser.add_argument(
        "--problem",
        default="Operational work is scattered across tools, making it hard to know what changed and what to do next.",
    )
    parser.add_argument(
        "--solution",
        default="BuildAndDo turns an observed business problem into a bounded mission, verifies the result, and keeps the evidence.",
    )
    parser.add_argument(
        "--pitch",
        default="BuildAndDo watches the important parts of a small business, explains what changed, and turns the next best action into a verified task.",
    )
