...
# Slides — DAF NV027 Brain-Inspired Low-SWaP

Status: scaffold. Add numbered slide source files here and preserve the final
rendered deck digest. Every quantitative claim cites an evidence ID. Confirm the
slide limit against current official instructions before final review.
