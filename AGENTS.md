...
|------------------------------|------------------|-------------------------------------------------------------|
| `ci:test`                    | Test             | Lint, web coverage, public adapters, native Discord/research parser, PocketBase dossier/suite checks, portable suite and foundry execution/replay/export coverage, and manifest/lock integrity |
