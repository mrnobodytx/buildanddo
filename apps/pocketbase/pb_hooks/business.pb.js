...
onRecordCreateRequest((e) => require(`${__hooks}/business-policy.js`).progress(e), 'tutorial_progress');
onRecordUpdateRequest((e) => require(`${__hooks}/business-policy.js`).progress(e), 'tutorial_progress');
onRecordDeleteRequest((e) => require(`${__hooks}/business-policy.js`).progress(e), 'tutorial_progress');
