...
// Original production filename: 1788798543_updated_erp_tasks.js
//   (PocketBase admin-UI generated, 2026-09-07T16:29:03.000Z).
// Renumbered to 1788950007 because the original number sorts before
...
// Collection: erp_tasks (the pbc_ id below is "pbc_" + crc32("base" + name), which
...
migrate((app) => {
  const collection = app.findCollectionByNameOrId("pbc_4251539635")
