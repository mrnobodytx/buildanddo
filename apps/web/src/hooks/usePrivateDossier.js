...
// Created:     2026-09-15
// Depends:     apps/web/src/lib/privateDossier.js, apps/web/src/contexts/AuthContext.jsx
// EnumType:    Adapter
// EnumEdges:   CONSUMES apps/web/src/lib/privateDossier.js; CONSUMES apps/web/src/contexts/AuthContext.jsx
// DAG Node:    none
...
export function usePrivateDossier(query = '', page = 1) {
    ...
    const api = useMemo(() => createDossierClient({ client: pb, accountId, demo,
        isCurrent: () => live.current.mounted && live.current.scope === scope }), [accountId, demo, scope]);
