...
export const progressionFixture = (overrides = {}) => ({
    ...
    plan_day: 11,
    projection_day: 11,
    projection_behind_days: 0,
    day_source: 'anchor-rule',
    day_disagreement: false,
    day_anchor: {
        plan_window_start: '2026-09-01', day_timezone: 'America/Chicago', canonical_anchor_day: 8, canonical_anchor_date: '2026-09-08', anchor_rule_day: 11,
