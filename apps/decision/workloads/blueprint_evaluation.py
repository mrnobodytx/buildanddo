...
# Created:     2026-09-17
# Depends:     apps/research/blueprints.py, apps/decision/contract.py, apps/decision/primitives.py
# EnumType:    Adapter
# EnumEdges:   CONSUMES apps/research/blueprints.py; CONSUMES apps/decision/contract.py; CONSUMES apps/decision/primitives.py
# DAG Node:    none
...
from apps.research.blueprints import Blueprint, COMPONENT_TYPES
