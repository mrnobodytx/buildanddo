...
| 2 | README rewritten from a survey of the tree; generated roadmap block | `python scripts/ci/readme_check.py --check && echo PASS` | done |
...
- May touch: `README.md`, `CHANGELOG.md`, `scripts/ci/readme_check.py`, `scripts/ci/changelog_gen.py`
  (the skip trailer only), `.github/workflows/changelog.yml`, `.github/workflows/pr-governance.yml` and
