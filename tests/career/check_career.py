...
# Created:     2026-09-22
# Depends:     tests/career/test_career.py, apps/career
# EnumType:    Test
# EnumEdges:   DEPENDS_ON tests/career/test_career.py; VALIDATES apps/career
# DAG Node:    none
...
def main() -> int:
    ...
    def run() -> unittest.TestResult:
        suite = unittest.defaultTestLoader.loadTestsFromName("tests.career.test_career")
