...
# Created:     2026-09-23
# Depends:     tests.world_twin.test_world_twin.py, apps/world_twin
# EnumType:    Test
# EnumEdges:   DEPENDS_ON tests.world_twin.test_world_twin.py; VALIDATES apps/world_twin
# DAG Node:    none
...
def main() -> int:
    ...
    def run() -> unittest.TestResult:
        suite = unittest.defaultTestLoader.loadTestsFromNames(["tests.world_twin.test_world_twin"])
